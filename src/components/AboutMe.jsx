...
const AboutMe = () => {
  return (
    <div id="about-me" className="w-[100%] h-full mt-[50px] flex justify-between">
      <div>
        ...
        <p className="w-[750px] h-full mt-[15px] font-poppins text-black text-[21px] ml-[56px] font-normal leading-normal tracking-[0.63px] ">
        👋 I'm           <a
            href="https://www.linkedin.com/in/syed-mohammed-askari-rizvi-a9b4061a3"
            className="text-sky-500"
            target="_blank"
            rel="noopener noreferrer"
          ><u>Askari</u></a>, 🎓 BCA'24, and based in 📍 Lucknow, India. <br/> I'm a React.js Developer with enthusiasm to expand my knowledge about technologies.
          <br /> <br />
          <ul>
